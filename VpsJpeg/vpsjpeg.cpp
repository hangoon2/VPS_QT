...
bool VpsJpeg::VJ_OpenJpg(int nHpNo, BYTE* pJpgSrc, int nJpgSrcLen)
{
    m_mJpg[nHpNo-1].lock();
...
bool VpsJpeg::VJ_RotateLeft(int nHpNo)
{
    m_mJpg[nHpNo-1].lock();
...
bool VpsJpeg::VJ_RotateRight(int nHpNo)
{
    m_mJpg[nHpNo-1].lock();
...
bool VpsJpeg::VJ_Encode(int nHpNo, BYTE *o_pJpgDst, int *o_pnJpgDstLen, int nJpgQuality)
{
    m_mJpg[nHpNo-1].lock();
...
bool VpsJpeg::VJ_Copy(int nHpNo, QImage* o_image, int x, int y)
{
    m_mJpg[nHpNo-1].lock();
